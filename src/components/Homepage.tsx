        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="md:col-span-1">
              <div className="flex items-center space-x-2 mb-4">
                <div className="w-10 h-10 bg-gradient-to-br from-primary to-primary/80 rounded-lg flex items-center justify-center">
                  <div className="w-5 h-5 bg-white rounded transform rotate-45" />
                </div>
                <span className="text-xl font-bold">
                  Ruby<span className="text-primary">Con</span>
                </span>
              </div>
              <p className="text-sm text-muted-foreground mb-4">
                Building the future of decentralized finance with transparency and security.
              </p>
              <div className="flex space-x-3">
                {['Twitter', 'Telegram', 'Discord'].map((social) => (
                  <div
                    key={social}
                    className="w-9 h-9 rounded-lg bg-secondary border border-primary/20 hover:border-primary/40 flex items-center justify-center cursor-pointer transition-colors"
                  >
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                {['Support Center', 'Contact Us', 'FAQ', 'Terms of Service'].map((link) => (
                  <li key={link}>
                    <button
                      onClick={() => link === 'Support Center' ? onPageChange('support') : link === 'Contact Us' ? onPageChange('contact') : null}
                      className="hover:text-primary transition-colors"
                    >
                      {link}
                    </button>
            ...
            <div>
              ...
              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">RBQ Price</span>
                  <span className="font-semibold text-primary">{tokenPrice.inr}</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-muted-foreground">24h Change</span>
                  <span className={`font-semibold ${tokenPrice.isPositive ? 'text-green-500' : 'text-red-500'}`}>
                    {tokenPrice.change24h}
                  </span>
                </div>
                <div className="flex items-center justify-between text-sm">
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between text-sm text-muted-foreground">
            <p>© 2025 RubyCon. All rights reserved.</p>
